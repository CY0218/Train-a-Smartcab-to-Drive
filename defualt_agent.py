...
#                self.epsilon = float(1)/math.exp(float(self.a*self.total_trails))
    ...
    def build_state(self):
        ...
        state = (('light',inputs['light']),('oncoming', inputs['oncoming']), ('left', inputs['left']), ('right', inputs['right']), waypoint)
        ...
        if self.learning is True:
            if state not in self.Q:
                ...
                for action in self.valid_actions:
                    self.Q[state][action] = 0 ## creating a new empty state
...
def run():
    ...
    sim = Simulator(env, update_delay = 0.000001, log_metrics = True, optimized = False, display = False)
